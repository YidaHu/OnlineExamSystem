...
const PAPERS: Paper[] = [
  ...
  {id: 3, name: '2018年工商管理硕士考试', content: "MBA即工商管理硕士（Master of Business Administration，简称MBA）是商业界普遍认为晋身管理阶层的一块踏脚石。现时不少学校为了开源，都与世界知名的大学商学院合作，销售他们的工商管理硕士课程。通常报考MBA都需要有GMAT资历。"},
  {
    id: 4,
